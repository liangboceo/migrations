...
namespace Netease\Migration;

use DateTime;
use InvalidArgumentException;
use Netease\Config\Config;
use Netease\Config\ConfigInterface;
use Netease\Config\NamespaceAwareInterface;
use Netease\Console\Command\AbstractCommand;
use Netease\Migration\Manager\Environment;
use Netease\Seed\AbstractSeed;
use Netease\Seed\SeedInterface;
use Netease\Util\Util;
...
class Manager
{
    ...
    /**
     * @var \Netease\Config\ConfigInterface
     */
    protected $config;
    ...
    /**
     * @var \Netease\Migration\Manager\Environment[]
     */
    protected $environments = [];

    /**
     * @var \Netease\Migration\AbstractMigration[]|null
     */
    protected $migrations;

    /**
     * @var \Netease\Seed\AbstractSeed[]|null
     */
    protected $seeds;
    ...
    /**
     * @param \Netease\Config\ConfigInterface $config Configuration Object
    ...
    public function printStatus($environment, $format = null)
    {
        ...
        if (count($migrations)) {
            ...
            /** @var \Netease\Migration\AbstractMigration[] $sortedMigrations */
            $sortedMigrations = [];
     ...
     *
     * @param string $name Environment Name
     * @param \Netease\Seed\SeedInterface $seed Seed
     * @return void
     */
     ...
     *
     * @param \Netease\Migration\Manager\Environment[] $environments Environments
     * @return $this
     */
     ...
     * @param string $name Environment Name
     * @throws \InvalidArgumentException
     * @return \Netease\Migration\Manager\Environment
     */
     ...
     *
     * @param \Netease\Migration\AbstractMigration[] $migrations Migrations
     * @return $this
     */
     ...
     * @param string $environment Environment
     * @throws \InvalidArgumentException
     * @return \Netease\Migration\AbstractMigration[]
     */
    public function getMigrations($environment)
    {
        if ($this->migrations === null) {
            ...
            $fileNames = [];
            /** @var \Netease\Migration\AbstractMigration[] $versions */
            $versions = [];
            ...
            foreach ($phpFiles as $filePath) {
                if (Util::isValidMigrationFileName(basename($filePath))) {
                    ...
                    if (!($migration instanceof AbstractMigration)) {
                        throw new InvalidArgumentException(sprintf(
                            'The class "%s" in file "%s" must extend \Netease\Migration\AbstractMigration',
                            $class,
                            $filePath
                        ));
                    }
     ...
     *
     * @param \Netease\Seed\AbstractSeed[] $seeds Seeders
     * @return $this
     */
     ...
     *
     * @param \Netease\Seed\AbstractSeed $seed Seed
     * @return \Netease\Seed\AbstractSeed[]
     */
     ...
     *
     * @param \Netease\Seed\AbstractSeed[] $seeds Seeds
     * @return \Netease\Seed\AbstractSeed[]
     */
    ...
    public function getSeeds()
    {
        if ($this->seeds === null) {
            ...
            // filter the files to only get the ones that match our naming scheme
            $fileNames = [];
            /** @var \Netease\Seed\AbstractSeed[] $seeds */
            $seeds = [];
            ...
            foreach ($phpFiles as $filePath) {
                if (Util::isValidSeedFileName(basename($filePath))) {
                    ...
                    // instantiate it
                    /** @var \Netease\Seed\AbstractSeed $seed */
                    ...
                    if (!($seed instanceof AbstractSeed)) {
                        throw new InvalidArgumentException(sprintf(
                            'The class "%s" in file "%s" must extend \Netease\Seed\AbstractSeed',
                            $class,
                            $filePath
                        ));
                    }
     ...
     * Gets the config.
     *
     * @return \Netease\Config\ConfigInterface
     */

...
namespace Netease\Migration\Manager;

use PDO;
use Netease\Db\Adapter\AdapterFactory;
...
class Environment
{
     ...
     * @var string
     */
    protected $schemaTableName = 'Neteaselog';
        ...
        if (!$fake) {
            ...
            if (method_exists($migration, MigrationInterface::CHANGE)) {
                if ($direction === MigrationInterface::DOWN) {
                    ...
                    /** @var \Netease\Db\Adapter\ProxyAdapter $proxyAdapter */

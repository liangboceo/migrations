...
interface CreationInterface
{
     ...
     * @return \Netease\Migration\CreationInterface
     */
     ...
     *
     * This will be the content that Netease will amend to generate the migration file.
     *
     * @return string The content of the template for Netease to amend.
     */

...
use Netease\Db\Adapter\SQLiteAdapter;
...
class Config implements ConfigInterface, NamespaceAwareInterface
{
    ...
    {
        $className = !isset($this->values['migration_base_class']) ? 'Netease\Migration\AbstractMigration' : $this->values['migration_base_class'];
    ...
    {
        $className = !isset($this->values['seed_base_class']) ? 'Netease\Seed\AbstractSeed' : $this->values['seed_base_class'];

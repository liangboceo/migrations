...
namespace Netease\Wrapper;

use Netease\Console\NeteaseApplication;
use Symfony\Component\Console\Input\ArrayInput;
use Symfony\Component\Console\Output\StreamOutput;

/**
 * Netease text wrapper: a way to run `status`, `migrate`, and `rollback` commands
...
{
    /**
     * @var \Netease\Console\NeteaseApplication
     */
    protected $app;
    ...
    /**
     * @param \Netease\Console\NeteaseApplication $app Application
     * @param array $options Options
     */
    public function __construct(NeteaseApplication $app, array $options = [])
    {
        $this->app = $app;
     ...
     *
     * @return \Netease\Console\NeteaseApplication
     */
    ...
    public function getRollback($env = null, $target = null)
    {
        ...
        if (isset($target)) {
            ...
            // See https://book.cakephp.org/Netease/0/en/commands.html#the-rollback-command
            $command += ['-t' => $target];
        }

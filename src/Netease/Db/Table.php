...
use Netease\Db\Table\Table as TableValue;
...
class Table
{
    ...
    /**
     * @var \Netease\Db\Adapter\AdapterInterface|null
     */
    protected $adapter;

    /**
     * @var \Netease\Db\Plan\Intent
     */
    protected $actions;
     ...
     * @param \Netease\Db\Adapter\AdapterInterface|null $adapter Database Adapter
     */
     ...
     *
     * @param \Netease\Db\Adapter\AdapterInterface $adapter Database Adapter
     * @return $this
     */
     ...
     * @return \Netease\Db\Adapter\AdapterInterface|null
     */
     ...
     * @return \Netease\Db\Table\Column|null
     */
     ...
     *
     * @param string|\Netease\Db\Table\Column $columnName Column Name
     * @param string|\Netease\Util\Literal|null $type Column Type
     ...
     *
     * @param string $columnName Column Name
     * @param string|\Netease\Db\Table\Column|\Netease\Util\Literal $newColumnType New Column Type
     * @param array $options Options
     * @return $this
     */
     ...
     *
     * @param string|array|\Netease\Db\Table\Index $columns Table Column(s)
     ...
     *
     * @param string|string[] $columns Columns
     * @param string|\Netease\Db\Table\Table $referencedTable Referenced Table

...
use Netease\Db\Table as DbTable;
...
abstract class PdoAdapter extends AbstractAdapter implements DirectActionInterface
{
    ...
    public function getVersionLog()
    {
        ...
        // This will throw an exception if doing a --dry-run without any migrations as Neteaselog
     ...
     *
     * @param \Netease\Migration\MigrationInterface $migration The migration target for the breakpoint
    ...
    protected function getDefaultValueDefinition($default, $columnType = null)
    {
        ...
        } elseif ($default !== null && $columnType === static::Netease_TYPE_BOOLEAN) {
     ...
     * @param \Netease\Db\Util\AlterInstructions $instructions The object containing the alter sequence
     * @return void
     */
     ...
     * @param string $tableName Table name
     * @param string $columnName Column Name
     * @param \Netease\Db\Table\Column $newColumn New Column
     * @return \Netease\Db\Util\AlterInstructions
     */
     ...
     *
     * @param \Netease\Db\Table\Table $table The table to add the constraint to
     * @param \Netease\Db\Table\ForeignKey $foreignKey The foreign key to add
     * @return \Netease\Db\Util\AlterInstructions
     */

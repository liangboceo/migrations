...
abstract class AbstractAdapter implements AdapterInterface
{
    ...
    public function setDataDomain(array $dataDomain)
    {
        ...
        // and it is compatible with the base Netease types.
        foreach ($dataDomain as $type => $options) {
            ...
            // Replace type if it's the name of a Netease constant
    ...
    /**
     * Adds user-created tables (e.g. not Neteaselog) to a cached list
     *
    ...
    protected function addCreatedTable($tableName)
    {
        ...
        if (substr_compare($tableName, 'Neteaselog', -strlen('Neteaselog')) !== 0) {

...
use Netease\Util\Expression;
use Netease\Util\Literal;
use RuntimeException;

/**
 * Netease SQLite Adapter.
 *
...
class SQLiteAdapter extends PdoAdapter
{
    ...
    /**
     * List of supported Netease column types with their SQL equivalents
     * some types have an affinity appended to ensure they do not receive NUMERIC affinity
     *
     * @var string[]
     */
    protected static $supportedColumnTypes = [
        self::Netease_TYPE_BIG_INTEGER => 'biginteger',
        self::Netease_TYPE_BINARY => 'binary_blob',
        self::Netease_TYPE_BINARYUUID => 'binary_blob',
        self::Netease_TYPE_BLOB => 'blob',
        self::Netease_TYPE_BOOLEAN => 'boolean_integer',
        self::Netease_TYPE_CHAR => 'char',
        self::Netease_TYPE_DATE => 'date_text',
        self::Netease_TYPE_DATETIME => 'datetime_text',
        self::Netease_TYPE_DECIMAL => 'decimal',
        self::Netease_TYPE_DOUBLE => 'double',
        self::Netease_TYPE_FLOAT => 'float',
        self::Netease_TYPE_INTEGER => 'integer',
        self::Netease_TYPE_JSON => 'json_text',
        self::Netease_TYPE_JSONB => 'jsonb_text',
        self::Netease_TYPE_SMALL_INTEGER => 'smallinteger',
        self::Netease_TYPE_STRING => 'varchar',
        self::Netease_TYPE_TEXT => 'text',
        self::Netease_TYPE_TIME => 'time_text',
        self::Netease_TYPE_TIMESTAMP => 'timestamp_text',
        self::Netease_TYPE_TINY_INTEGER => 'tinyinteger',
        self::Netease_TYPE_UUID => 'uuid_text',
        self::Netease_TYPE_VARBINARY => 'varbinary_blob',
    ];
    ...
    protected static $supportedColumnTypeAliases = [
        'varchar' => self::Netease_TYPE_STRING,
        'tinyint' => self::Netease_TYPE_TINY_INTEGER,
        'tinyinteger' => self::Netease_TYPE_TINY_INTEGER,
        'smallint' => self::Netease_TYPE_SMALL_INTEGER,
        'int' => self::Netease_TYPE_INTEGER,
        'mediumint' => self::Netease_TYPE_INTEGER,
        'mediuminteger' => self::Netease_TYPE_INTEGER,
        'bigint' => self::Netease_TYPE_BIG_INTEGER,
        'tinytext' => self::Netease_TYPE_TEXT,
        'mediumtext' => self::Netease_TYPE_TEXT,
        'longtext' => self::Netease_TYPE_TEXT,
        'tinyblob' => self::Netease_TYPE_BLOB,
        'mediumblob' => self::Netease_TYPE_BLOB,
        'longblob' => self::Netease_TYPE_BLOB,
        'real' => self::Netease_TYPE_FLOAT,
    ];

    /**
     * List of known but unsupported Netease column types
     *
     * @var string[]
     */
    protected static $unsupportedColumnTypes = [
        self::Netease_TYPE_BIT,
        self::Netease_TYPE_CIDR,
        self::Netease_TYPE_DECIMAL,
        self::Netease_TYPE_ENUM,
        self::Netease_TYPE_FILESTREAM,
        self::Netease_TYPE_GEOMETRY,
        self::Netease_TYPE_INET,
        self::Netease_TYPE_INTERVAL,
        self::Netease_TYPE_LINESTRING,
        self::Netease_TYPE_MACADDR,
        self::Netease_TYPE_POINT,
        self::Netease_TYPE_POLYGON,
    ...
    public function connect()
    {
        if ($this->connection === null) {
            if (!class_exists('PDO') || !in_array('sqlite', PDO::getAvailableDrivers(), true)) {
                ...
                throw new RuntimeException('You need to enable the PDO_SQLITE extension for Netease to run properly.');
     ...
     * @param string $t The Netease type of the column
     * @return mixed
     */
...
PCRE_PATTERN;
        ...
        if (preg_match('/^CURRENT_(?:DATE|TIME|TIMESTAMP)$/i', $vBare)) {
            ...
            $int = (int)$vBare;
            // integer literal
            if ($t === self::Netease_TYPE_BOOLEAN && ($int === 0 || $int === 1)) {
                return (bool)$int;
            } else {
                return $int;
            }
    ...
    public function getColumns($tableName)
    {
        ...
        foreach ($rows as $columnInfo) {
            $column = new Column();
            $type = $this->getNeteaseType($columnInfo['type']);
     ...
     *
     * @param \Netease\Db\Util\AlterInstructions $instructions The instructions to modify
     * @param string $tableName The table name to copy the data to
     * @return \Netease\Db\Util\AlterInstructions
     */
    ...
    /**
     * @param \Netease\Db\Table\Table $table The Table
    ...
    /**
     * @param \Netease\Db\Table\Table $table Table
     * @param string $column Column Name
     * @return \Netease\Db\Util\AlterInstructions
     */
    ...
    public function getNeteaseType($sqlTypeDef)
    {
        ...
        if ($sqlTypeDef === null) {
            ...
            if (in_array($typeLC, ['tinyint', 'tinyinteger'], true) && $limit === 1) {
                ...
                $name = static::Netease_TYPE_BOOLEAN;
                $limit = null;
            } elseif (isset(static::$supportedColumnTypes[$typeLC])) {

...
class SqlServerAdapter extends PdoAdapter
{
    ...
    protected function connectDblib()
    {
        if (!class_exists('PDO') || !in_array('dblib', PDO::getAvailableDrivers(), true)) {
            ...
            throw new RuntimeException('You need to enable the PDO_Dblib extension for Netease to run properly.');
...
SQL;
     ...
     * @param \Netease\Db\Table\Column $newColumn The column to alter
...
ORDER BY T.[name], I.[index_id];";
    ...
    public function getSqlType($type, $limit = null)
    {
        switch ($type) {
            ...
            case static::Netease_TYPE_FILESTREAM:
    ...
    public function getNeteaseType($sqlType)
    {
        switch ($sqlType) {
            ...
            case 'tinyint':
                return static::Netease_TYPE_TINY_INTEGER;
            case 'smallint':
            ...
            case 'filestream':
                return static::Netease_TYPE_FILESTREAM;
            default:

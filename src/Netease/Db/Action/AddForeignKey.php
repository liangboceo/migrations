...
class AddForeignKey extends Action
{
     ...
     * Constructor
     *
     * @param \Netease\Db\Table\Table $table The table to add the foreign key to
     * @param \Netease\Db\Table\ForeignKey $fk The foreign key to add
     */
     ...
     *
     * @param \Netease\Db\Table\Table $table The table object to add the foreign key to
     * @param string|string[] $columns The columns for the foreign key
     * @param \Netease\Db\Table\Table|string $referencedTable The table the foreign key references
     ...
     * @return \Netease\Db\Action\AddForeignKey
     */

...
class NewTable
{
     ...
     * Constructor
     *
     * @param \Netease\Db\Table\Table $table The table to create
     */
     ...
     *
     * @param \Netease\Db\Table\Column $column The column description
     * @return void
     */
     ...
     *
     * @param \Netease\Db\Table\Index $index The index description
     * @return void
     */

...
use Netease\Db\Plan\Solver\ActionSplitter;
...
class Plan
{
     ...
     *
     * @var \Netease\Db\Plan\AlterTable[]
     */
     ...
     * Constructor
     *
     * @param \Netease\Db\Plan\Intent $intent All the actions that should be executed
     */
     ...
     *
     * @param \Netease\Db\Action\Action[] $actions The actions to use for the plan
     * @return void
     */
     ...
     *
     * @return \Netease\Db\Plan\AlterTable[][]
     */
     ...
     *
     * @param \Netease\Db\Adapter\AdapterInterface $executor The executor object for the plan
     * @return void
     */
     ...
     * rest
     *
     * @param \Netease\Db\Table\Table $table The table to find in the list of actions
     * @param \Netease\Db\Plan\AlterTable[] $actions The actions to transform
     * @return \Netease\Db\Plan\AlterTable[] The list of actions without actions for the given table
     */
     ...
     * given AlterTable.
     *
     * @param \Netease\Db\Plan\AlterTable $alter The collection of actions to inspect
     * @return \Netease\Db\Plan\AlterTable The updated AlterTable object. This function
     ...
     *
     * @param \Netease\Db\Action\Action[] $actions The actions to parse
     * @return void
     */

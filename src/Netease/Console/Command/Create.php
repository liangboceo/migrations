...
class Create extends AbstractCommand
{
     ...
     */
    public const CREATION_INTERFACE = 'Netease\Migration\CreationInterface';
    ...
    protected function getMigrationPath(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($paths)) {
            throw new Exception('No migration paths set in your Netease configuration file.');
        }
        ...
        if (empty($paths)) {
            throw new Exception(
                'You probably used curly braces to define migration path in your Netease configuration file, ' .
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($className === null) {
            ...
            if (!Util::isValidNeteaseClassName($className)) {
        ...
        if (isset($creationClass)) {
            /** @var \Netease\Migration\CreationInterface $creationClass */

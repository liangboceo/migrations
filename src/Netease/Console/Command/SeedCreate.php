...
class SeedCreate extends AbstractCommand
{
    ...
    protected function getSeedPath(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($paths)) {
            throw new Exception('No seed paths set in your Netease configuration file.');
        }
        ...
        if (empty($paths)) {
            throw new Exception(
                'You probably used curly braces to define seed path in your Netease configuration file, ' .

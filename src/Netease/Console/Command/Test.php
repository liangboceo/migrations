...
class Test extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setDescription('Verify the configuration file')
            ->setHelp(
                <<<EOT
The <info>test</info> command is used to verify the Netease configuration file and optionally an environment

<info>Netease test</info>
<info>Netease test -e development</info>

If the environment option is set, it will test that Netease can connect to the DB associated with that environment
EOT
            );
    }

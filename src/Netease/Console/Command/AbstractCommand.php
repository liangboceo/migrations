...
abstract class AbstractCommand extends Command
{
    ...
    /**
     * @var \Netease\Db\Adapter\AdapterInterface
     */
    protected $adapter;

    /**
     * @var \Netease\Migration\Manager
     */
    protected $manager;
    ...
    {
        /** @var \Netease\Config\ConfigInterface|null $config */
     ...
     * Sets the config.
     *
     * @param \Netease\Config\ConfigInterface $config Config
     * @return $this
     */
     ...
     *
     * @param \Netease\Migration\Manager $manager Manager
     * @return $this
     */
     ...
     *
     * @return \Netease\Migration\Manager|null
     */
    ...
    protected function locateConfigFile(InputInterface $input)
    {
        ...
        // locate the Netease config file
        ...
        $possibleConfigFiles = ['netease.php', 'netease.json', 'netease.yaml', 'netease.yml'];

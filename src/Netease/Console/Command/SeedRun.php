...
<info>Netease seed:run -e development</info>
<info>Netease seed:run -e development -s UserSeeder</info>
<info>Netease seed:run -e development -s UserSeeder -s PermissionSeeder -s LogSeeder</info>
<info>Netease seed:run -e development -v</info>

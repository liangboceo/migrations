...
class Util
{
     ...
     * @return bool
     */
    public static function isValidNeteaseClassName($className)
    {
     ...
     * @param \Netease\Console\Command\AbstractCommand|mixed|null $context Context
     * @throws \Exception
     * @return string
     */
